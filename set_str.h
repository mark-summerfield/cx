...
// If owning, SetStr takes ownership of the new value (set.g., use
// strdup()).
...
// not in set2. If owns the result is and owned copy.
...
// common.. If owns the result is and owned copy.
...
// (with no duplicates of course).. If owns the result is and owned copy.
...
// Returns the set as a caller-owns string of sep-separated strings.
